...
2. Standardizing the names of sites across three datasets.
3. Checking for missing data in variables across three datasets.

Saved the initial cleaned files as: training_meta_clean, training_trait_clean, training_soil_clean
